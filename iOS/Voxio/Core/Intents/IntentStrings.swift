...
enum IntentStrings {
    nonisolated static func appNotRunning(_ lang: Language) -> String {
        switch lang {
    ...
    nonisolated static func speakerUnreachable(_ name: String, _ lang: Language) -> String {
        switch lang {
    ...
    nonisolated static func speakerNotFound(_ name: String, _ lang: Language) -> String {
        switch lang {
    ...
    nonisolated static func joined(_ source: String, _ target: String, _ lang: Language) -> String {
        switch lang {
    ...
    nonisolated static func left(_ name: String, _ lang: Language) -> String {
        switch lang {
